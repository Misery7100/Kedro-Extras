...
from carousel_ranking_v2.extras.utils.types import *
...
def fetch_chunkwise(
    ...
    while flag:
        ...
        log.info(f'fetching chunk #{cnt}')

        data = res.fetchmany(chunksize)
        ...
        if not data: 
            ...
            build_chunk(df, os.path.join(tempdir, f'{cnt}.hdf5'))
